...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('fakeLunchHub', ['ngAnimate', 'ngCookies', 'ngTouch', 'ngSanitize', 'ngMessages', 'ngAria', 'ngResource', 'ui.router', 'ui.bootstrap', 'toastr']).constant('malarkey', malarkey).constant('moment', moment).config(_index.config).config(_index2.routerConfig).run(_index3.runBlock).service('githubContributor', _githubContributor.GithubContributorService).service('webDevTec', _webDevTec.WebDevTecService).controller('MainController', _main.MainController).directive('acmeNavbar', _navbar.NavbarDirective).directive('acmeMalarkey', _malarkey.MalarkeyDirective);
...
/***/ function(module, exports) {
	...
	var MainController = exports.MainController = function () {
	  ...
	  function MainController($timeout, webDevTec, toastr) {
	    ...
	    this.awesomeThings = [];
	    this.classAnimation = '';
	    this.creationDate = 1487849203717;
	    this.toastr = toastr;
